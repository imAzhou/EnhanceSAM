...
class SegLocalVisualizer(Visualizer):
    ...
    def __init__(self,
                 ...
                 vis_backends: Optional[Dict] = [dict(type='LocalVisBackend')],
        ...
        self.set_dataset_meta(classes, palette, dataset_name)
    ...
    def add_datasample(
        ...
        mmcv.imwrite(mmcv.bgr2rgb(drawn_img), f'{self.save_dir}/{name}.png')
